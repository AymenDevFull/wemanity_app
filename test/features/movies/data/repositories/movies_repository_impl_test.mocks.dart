...
// in wemanity_app/test/features/movies/data/repositories/movies_repository_impl_test.dart.
...
class MockHttpResponse extends _i1.Mock
  ...
  @override
  _i2.Response<dynamic> get response => (super.noSuchMethod(
        Invocation.getter(#response),
        returnValue: _FakeResponse_3<dynamic>(
          this,
          Invocation.getter(#response),
        ),
      ) as _i2.Response<dynamic>);
}
